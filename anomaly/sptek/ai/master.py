...
def updateMuch(config):
    if isinstance(config, list):
        munch = []
        for item in config:
            munch.append(createMuch(item))
        return munch
    else:
        return createMuch(config)
...
class Master(metaclass=MetaclassSingleton):
    ...
    # def database(self, name=None, dtype=None):
    #     if dtype is not None:
    #         return lookupMuch(updateMuch(self.parser.database()), 'type', dtype)
    #     return lookupMuch(updateMuch(self.parser.database()), 'name', name)
    ...
    # def searcher(self, name=None, dtype=None):
    #     if dtype is not None:
    #         return lookupMuch(updateMuch(self.parser.searcher()), 'type', dtype)
    #     return lookupMuch(updateMuch(self.parser.searcher()), 'name', name)
    ...
    #     if dtype is not None:
    #         return lookupMuch(updateMuch(self.parser.import_model()), 'type', dtype)        
    #     if lookup == 'first':
    #         return lookupMuch(updateMuch(self.parser.import_model()), 'name', name)        
    #     return updateMuch(self.parser.import_model())def repository(self, name=None, dtype=None, lookup='first'):
    
    def import_model(self, name=None, dtype=None, lookup='first'):
        return self._search_(self.parser.import_model(), name, dtype, lookup)

    # def machine(self, name=None, dtype=None):
    #     if dtype is not None:
    #         return lookupMuch(updateMuch(self.parser.machine()), 'type', dtype)
    #     return lookupMuch(updateMuch(self.parser.machine()), 'name', name)
    
    def machine(self, name=None, dtype=None, lookup='first'):
        return self._search_(self.parser.machine(), name, dtype, lookup)
    
    # def repository(self, name=None, dtype=None):
    #     if dtype is not None:
    #         return lookupMuch(updateMuch(self.parser.repository()), 'type', dtype)
    #     return lookupMuch(updateMuch(self.parser.repository()), 'name', name)
    
    def repository(self, name=None, dtype=None, lookup='first'):
        return self._search_(self.parser.repository(), name, dtype, lookup)
    
    
    # def scheduler(self, name=None, dtype=None):
    #     if dtype is not None:
    #         return lookupMuch(updateMuch(self.parser.scheduler()), 'type', dtype)
    #     return lookupMuch(updateMuch(self.parser.scheduler()), 'name', name)
