        ...
        if action == 'train':
            ...
            if meta.type == 'sequential':
                if meta.algorithm == 'BiLSTM':
                    ...
                    model.build()
                    model._is_transfer_ = meta.transfer if hasattr(meta, 'transfer') else False
                    model._is_continual_ = meta.continual if hasattr(meta, 'continual') else False
                    return model
